...
>
> For third-party buying, geographic targeting is limited by any existing country settings in your Third-Party Buying Filters at the network level. If countries are included in your Third-Party Buying Filters, only those countries and the regions and cities within them will be available for targeting.
...
> [!IMPORTANT]
> Country, region/state, and city targeting is supported by an IP lookup service provided by [Digital Envoy](https://www.digitalelement.com). For more information, see [How Geography Targeting Works](../monetize/how-geography-targeting-works.md).
...
> [!IMPORTANT]
> Metro code targeting is supported by an IP lookup service provided by [Digital Envoy](https://www.digitalelement.com). For more information, see [How Geography Targeting Works](../monetize/how-geography-targeting-works.md)
