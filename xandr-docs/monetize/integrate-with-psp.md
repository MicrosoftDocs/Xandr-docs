...
SSP customers can integrate with Microsoft Advertising, and in turn, PSP, in the following ways:
...
Once inventory has been integrated with Monetize, proceed with the steps on the pages below:
