...
- Reach out to the tag provider to add the missing duration information or revise the format. For example:
     ...
     :::image type="content" source="media/video-duration.png" alt-text="Screenshot of adding duration.":::
...
- Reach out to the tag provider to update the creative with at least one of the recommended video formats.
  ...
  :::image type="content" source="media/video-formats.png" alt-text="Screenshot of VAST Format.":::

  Sample XML with recommended VPAID formats:

   :::image type="content" source="media/media-files.png" alt-text="Screenshot of VPAID format.":::
...
For sample XML snippets with the recommended formats, see the [No video formats detected section](#no-video-formats-detected).
