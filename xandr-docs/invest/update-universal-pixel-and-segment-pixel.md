...
You can find further information on how to enable the binary consent mode for Universal Pixel in our [documentation](https://learn.microsoft.com/en-us/xandr/invest/set-up-consent-mode-in-universal-pixel).  
