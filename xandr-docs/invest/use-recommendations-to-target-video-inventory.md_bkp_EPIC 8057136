...
1. From any video line item, select the **Analytics** tab and find your recommendations in the **Video Inventory Recommendations** section.
...
1. Then, do one of the following:
   ...
   | Task | Steps |
   |--|--|
   | **To download all recommendations for later analysis** | Select **Download** to export a CSV-formatted list of your recommendations. You can then review these with your inventory manager. |
   | **To create an allow list from specific recommendations** | Select one or more recommendations and select **Add to Line Item Allowlist** to create a new allowlist with this inventory.Then select **Create Allowlist**. |
