...
In addition, use **Evaluate Orders** to compare it to all orders in the system. This helps to uncover opportunities to improve yield and to evaluate outgoing proposals before they are sent to prospective customers. Sales planners and account managers often use **Evaluate Orders** when building media plans and proposals in response to an advertiser's RFP.
