---
title: Microsoft Invest - Switch Between User Accounts
...
# Microsoft Invest - Switch between user accounts
...
1. Launch the **account switcher** by selecting on the **member name** in the top right-hand corner of the application.
1. Select the **Switch Member** button.

    This action will list all the accounts that you have access to.
1. Select on any other row of the list to switch to that user account.
...
1. You can set a default account by selecting **Set as Default** after selecting that account.
