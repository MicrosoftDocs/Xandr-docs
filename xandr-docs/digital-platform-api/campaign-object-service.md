...
|`insertionOrder` | object | The automatically created advertiser to house all PSP line items. See [insertion order service documentation](insertion-order-service.md) for more information. Deletion is blocked at the platform level.|
