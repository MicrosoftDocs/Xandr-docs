...
Bidder level deals need to be created manually. These deals are public and accessible to everyone. So, any client can set the deal up manually and add it to the line item.
