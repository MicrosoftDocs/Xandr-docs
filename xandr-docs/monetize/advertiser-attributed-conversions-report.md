---
title: Microsoft Monetize - Advertiser Attributed Conversions Report
description: In this article, learn about the Advertiser attributed conversions report along with the dimensions and metrics associated with it.
ms.date: 10/28/2023
---

# Microsoft Monetize - Advertiser attributed conversions report
...
| Post Click/Post View Conversion | Yes | Whether the conversion was a post-click (PC) or post-view (PV) conversion.<br> - **Cross-device**: The conversion is attributed to having cross-device enabled.<br> - **IP**: Additionally specified, the conversion is attributed to having IP attribution enabled. |
