...
When you create a placement in Microsoft Advertising, you:

- Select the size and types of creatives that can serve on the placement.
- Set a reserve price for either both managed and external demand or just for external demand.
- Self-classify the placement with categories and sensitive attributes for targeting in line items and for reporting.

For more information on working with placements, please explore the pages listed below.
