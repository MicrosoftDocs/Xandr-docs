...
# Microsoft Curate - Switch between user accounts
...
1. Launch the **account switcher** by selecting the **member name** in the upper-right corner of the application.
...
1. You can set a default account by selecting **Set as Default** after selecting that account. If you set up a default account, every time you log in to the system, you are assigned to your default account. It doesn’t matter which account you were in last. It will always return to the default account every time you log in again. Also, you can change the default account whenever you want by selecting **Set as Default**.
