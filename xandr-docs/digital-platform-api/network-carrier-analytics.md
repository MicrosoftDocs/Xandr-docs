...
| `venue` | string | Yes | `"Venue Name"` | The name of the cluster of domain, site, tag, and user country/region that Xandr's' optimization system uses to determine bid valuations. A campaign cannot targeted a venue explicitly. |
