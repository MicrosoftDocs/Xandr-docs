...
- 8345778: Added support for [GPID (Global Placement Id)](android-sdk-code-samples-set-gpid.md)
...
- MS-5228 Fix for MRAID related performance issue ([Android SDK Initialization v8.0](android-sdk-initialization-v8-0.md))
...
- MS-5172 Support for Global Privacy Platform (GPP) ([SDK Privacy for Android](sdk-privacy-for-android.md))
- MS-5132 Add a boolean to notify success / failure for XandrAd InitListener ([Github #74](https://github.com/appnexus/mobile-sdk-android/issues/74)) ([Android SDK Initialization v8.0](android-sdk-initialization-v8-0.md))
- MS-5024 Updated ProGuard settings ([Github #65](https://github.com/appnexus/mobile-sdk-android/issues/65))
...
1. Xandr SDK v8.0 Removal Notice for Deprecated APIs ([Github #71](https://github.com/appnexus/mobile-sdk-android/issues/71))
2. Xandr will be moving toward counting "Viewable Impressions - for Direct-Sold Inventory" ([Github #72](https://github.com/appnexus/mobile-sdk-android/issues/72))

### Improvement/Bug fixes

- MS-4793 Added permission for AD_ID to fetch AAID on Android 13+
- MS-4999 Removed the RendererID-deprecation notice
- MS-5008 Added onAdImpression callback for the Banner and Interstitial Ads ([Android SDK Ad Units](android-sdk-ad-units.md))
...
- MS-4705 Memory leak caused by AdWebView ([Github #57](https://github.com/appnexus/mobile-sdk-android/issues/57))
- MS-4880 Exposed API for exiting from full screen banner video ([API for Exiting Banner Video from Fullscreen](api-for-exiting-banner-video-from-fullscreen.md))
- MS-4953 Added support for passing Publisher/Extended User Id via `ANSDKSetting.setUserIds(List<ANUserId> userIdList)`. ([User ID(s) Mapping on Android](user-id-s-mapping-on-android.md))
...
- MS-4946 Optimized SDK logging for OMID SDK ([Github #68](https://github.com/appnexus/mobile-sdk-android/pull/68))
- MS-4947 Updated README file ([Github #49](https://github.com/appnexus/mobile-sdk-android/pull/49))
...
- MS-4847 Improved impression tracking methodology for Native Ads, trackers to be fired on Render ([Android SDK](android-sdk.md))
...
- MS-4710 Make bid price available as part of AdResponseInfo ([Ad Response Info Class for Android](ad-response-info-class-for-android.md))

### Bug fixes

#### Fixed

- MS-4811 Issue with MAR.stop() api when used with enabled background threading ([Github #58](https://github.com/appnexus/mobile-sdk-android/issues/58))
...
- MS-4832 NullPointerException being thrown in certain MRAID implementations ([Github #66](https://github.com/appnexus/mobile-sdk-android/issues/66))
...
- MS-4705 Memory leak caused by AdWebView ([Github #57](https://github.com/appnexus/mobile-sdk-android/issues/57))
- MS-4809 NullPointerException while processing the AdResponse ([Github #64](https://github.com/appnexus/mobile-sdk-android/issues/64))
- MS-4810 Performance issues while firing Impression tracker ([Github #63](https://github.com/appnexus/mobile-sdk-android/issues/63))
- MS-4811 Issue with ANMultiAdRequest.stop() ([Github #58](https://github.com/appnexus/mobile-sdk-android/issues/58))
...
- MS-4749 Add support for Unified ID 2.0 (UID2) ([User ID(s) Mapping on Android](user-id-s-mapping-on-android.md))
- MS-4760 Added support for Google Additional Consent field
- MS-4772 Exposed API in ANMultiAdRequest to stop the Ad Request ([Multi Ad Request for Android](multi-ad-request-for-android.md))
...
- MS-4796 Fixed an issue with Ad text being sent with unescaped single quotes ([Github #61](https://github.com/appnexus/mobile-sdk-android/issues/61))
...
- MS-4711 Exposed API in Native Custom element to support clickUrl and clickFallbackUrl for Native Ad ([Listen to Native Ad Events on Android](listen-to-native-ad-events-on-android.md))
...
- MS-4659, MS-4674 Added support for User Id from external sources(Criteo, NetID, LiverRamp, The Trade Desk) ([User ID(s) Mapping on Android](user-id-s-mapping-on-android.md))

### Improvements/Bug fixes

- MS-4671 Added minimum threshold of 100ms for callSetMraidRefreshFrequency
- MS-4679 Fixed ad load issue ([Github #59](https://github.com/appnexus/mobile-sdk-android/issues/59))
...
- MS-4387 Added support to pass traffic source and external inventory codes in Ad Request ([Support for External Inventory Code and Traffic Source Code on Android](support-for-external-inventory-code-and-traffic-source-code-on-android.md))
- MS-4567 Added support for overriding Country and Zip Codes ([Support for Overriding Country Codes and Zip Codes on Android](support-for-overriding-country-codes-and-zip-codes-on-android.md))
...
- MS-4412 Added support for listening to Ad Expiry events for Native Ads ([Listener for onAdAboutToExpire on Android](listener-for-onadabouttoexpire-on-android.md))
- MS-4449 Added support for setting test flags to bypass request filtering (for testing purposes only) ([Set Test Mode for Android](set-test-mode-for-android.md))
- MS-4459 AuctionId information is now available through AdResponseInfo class

### Mediation partner updates

- MS-4418 Discontinued support for Amazon, inMobi, Millennial Media and Mopub adapters ([Github Intent to Implement #52](https://github.com/appnexus/mobile-sdk-android/issues/52))
...
- MS-4232 Added support for executing the Ad request on background thread ([Background Threading on Android](background-threading-on-android.md))
- MS-4361 Added onAdImpression callback for the Native Ads ([Listen to Native Ad Events on Android](listen-to-native-ad-events-on-android.md))
...
- MS-4384 Added support for Auction timeout ([Set the Auction Timeout for Android](set-the-auction-timeout-for-android.md))
...
- MS-4214 Added (optional) support for lazy loading of AdUnits ([Lazy Load for Android](lazy-load-for-android.md))
...
- MS-4097 California Consumer Privacy Act (CCPA) Support ([SDK Privacy for Android](sdk-privacy-for-android.md))
...
- MS-4019: Added new API to Pause/Resume VideoAd ([Show Instream Video Ads on Android](show-instream-video-ads-on-android.md))

### Mediation partner upgrades

- Smart Server SDK v7.2.0
- FacebookAd SDK v5.5.0 (has breaking changes, please look at Mediation Docs - [Mediate with Android SDK](mediate-with-android-sdk.md), for updated integration instruction)
...
- MS-3807: Removed unused themes ([Github #41](https://github.com/appnexus/mobile-sdk-android/issues/41))
- MS-3809: Fixed disk read violation issue ([Github #40](https://github.com/appnexus/mobile-sdk-android/issues/40))
