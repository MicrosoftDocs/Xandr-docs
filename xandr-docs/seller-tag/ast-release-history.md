...
|---|---|---|
| [0.65.0](https://acdn.adnxs.com/ast/alpha/0.65/ast.js) | - Update fledge logic to use `deprecateURN` function instead of `auctionConfig` approach. <br> - Include `geooverride` information for AST context Interest Groups.| 4 November 2024 |
