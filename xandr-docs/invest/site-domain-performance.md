---
title: Microsoft Invest - Site Domain Performance Report
...
# Microsoft Invest - Site domain performance report
...
To view performance and optimization data by domain or mobile app for multiple advertisers, use the [Member Site Domain Performance Report](network-site-domain-performance-report.md).
...
1. Select **Reporting** from the appropriate top menu (depending on how your account has been configured).
    ...
    Or, from the Publishers top menu, select on **Prebid Server Premium** > **Analytics** > **Prebid Server Analytics**
