...
description: Use the Member Audio Analytics report to view audio event metrics across multiple buyers and sellers.
ms.date: 10/28/2023
---
...
**Advertiser**, select the **Currency 2.0** toggle to enable it, and select **Japanese Yen (JPY)** from the **Currency** menu, the report will show all monetary data in JPY, including data associated with child objects such as line items.
