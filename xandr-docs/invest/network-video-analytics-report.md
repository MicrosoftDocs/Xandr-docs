...
description: Use the Member Video Analytics report to view video event metrics across multiple buyers and sellers for a network member.
ms.date: 10/28/2023
---
...
| Video Content Language1 | No | The language of the video program in which ad will be played. For example, Spanish. |
...
| Video Content Duration| The length of the video content in seconds. <br> **Note**: The data for this metric is only available if the publisher has implemented video taxonomy. |
