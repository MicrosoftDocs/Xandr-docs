...
## Get to the Partnership Details screen
...
Click on a seller and click **Show Profile** to view profile information the seller has provided, including the main contact's name, phone number, email address, and a description of their business. You can contact the seller directly by sending a message within the **Activity Stream**. For more information about the **Activity Stream**, see [Communicate with the Seller](partnership-details-screen-buyer-view.md#communicate-with-the-seller).
