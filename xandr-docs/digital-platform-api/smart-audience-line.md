...
Create a JSON file and populate it with the appropriate values. For more information on creating an insertion order, see [Insertion orders and line items](insertion-orders-and-line-items.md)
