...
- [User ID Syncing with External Partners](user-id-syncing-with-external-partners.md): User ID syncing between Microsoft Advertising and its platform partners
