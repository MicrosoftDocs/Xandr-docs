...
- [Streaming Server-Side Segmentation](../data-providers/streaming-server-side-segmentation.md): This method associates individual users to segments in close to real-time, via the API.
