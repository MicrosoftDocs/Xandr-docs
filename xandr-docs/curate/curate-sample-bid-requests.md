...
1. In **Country**, select either **Any Country** or **Custom Country** (use the **Select Country** dropdown to select a country or region from the list).
...
1. Select **Search** to generate bid requests.
