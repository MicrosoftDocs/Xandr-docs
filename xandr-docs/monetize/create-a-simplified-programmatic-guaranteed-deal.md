...
1. Select the **Create from Scratch** option under **Creation Mode**. If you wish to create a new deal from a template, see [Create a programmatic guaranteed deal from a template](#create-a-programmatic-guaranteed-deal-from-a-template).
