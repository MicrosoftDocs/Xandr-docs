...
:::image type="content" source="media/minesweepergame.png" alt-text="Screenshot of the Game Play and Game Completion screen.":::

**Daily Challenge Menu Screens** - Above the fold, right side of menu screens.

:::image type="content" source="media/minesweeperdaily.png" alt-text="Screenshot of the Daily Challenge menu screen.":::
...
:::image type="content" source="media/jigsawgame.png" alt-text="Screenshot of the Microsoft Jigsaw Game Play and Game Completion screen.":::

**Menu Screens** - Below the fold, right side of the menu screens.

:::image type="content" source="media/jigsawmenu.png" alt-text="Screenshot of the Microsoft Jigsaw menu screen.":::
...
:::image type="content" source="media/sudokugame.png" alt-text="Screenshot of the Microsoft Sudoku Game Play and Game Completion screen.":::

**Menu Screens** - Below the fold, right side of the menu screens.

:::image type="content" source="media/sudokumenu.png" alt-text="Screenshot of the Microsoft Sudoku menu screen.":::
...
:::image type="content" source="media/mahjongmenu.png" alt-text="Screenshot of the Microsoft Mahjong menu screen.":::

**Daily Challenge Screens** - Above the fold, right side of screens.

:::image type="content" source="media/mahjongdaily.png" alt-text="Screenshot of the Microsoft Mahjong Daily Challenge screen.":::
...
:::image type="content" source="media/treasuremain.png" alt-text="Screenshot of the Microsoft Treasure Hunt menu screen.":::

**Game Play and Game Completion Screens** - Above the fold, right side of screen.

:::image type="content" source="media/treasuregame.png" alt-text="Screenshot of the Microsoft Treasure Game Play and Game Completion screen.":::
