...
|LiveIntent - Index Exchange ID | [liveintent.indexexchange.com](https://liveintent.indexexchange.com) | Index Exchange ID | Passthrough for Prebid Server Premium | No | No |
|LiveIntent - Triplelift ID | [liveintent.triplelift.com](https://liveintent.triplelift.com) | Triplelift SSP ID | Passthrough for Prebid Server Premium | No | No |
|LiveIntent - Rubicon ID | [rubiconproject.com](https://rubiconproject.com) | Rubicon SSP ID | Passthrough for Prebid Server Premium | No | No |
|LiveIntent - Openx ID | [openx.net](https://openx.net) | OpenX SSP ID | Passthrough for Prebid Server Premium | No | No |
|LiveIntent - Pubmatic ID | [pubmatic.com](https://pubmatic.com) | PubMatic SSP ID | Passthrough for Prebid Server Premium | No | No |
