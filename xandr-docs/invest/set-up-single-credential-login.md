...
As soon as a single credential login has been created for you, you will receive a welcome email with a link for setting your password. You need to use the link and follow the below steps to complete your login set-up.
