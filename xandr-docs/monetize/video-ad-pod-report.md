...
description: Learn how the Video Ad Pod Report can be used to show metrics for groups of ads delivered sequentially in between segments of non-commercial video programming. This page guides you to run this report. 
ms.date: 10/28/2023
---
