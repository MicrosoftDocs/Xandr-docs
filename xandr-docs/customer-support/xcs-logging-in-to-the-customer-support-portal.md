...
If you do not already have a portal account, please visit the [Login](https://support.ads.microsoft.com) page, click Proceed as a Guest, and in the next page, click **Contact Support**. Once your account is created, you will be sent a welcome email with your user ID and temporary password to log in. You can set your own password following the link in the welcome mail.
