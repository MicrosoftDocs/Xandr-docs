...
| Parameter   | Definition                                                                                                                                                                                                                                                                                                      |
| :---------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `country` | Overrides a cookie's current country or region geo code with whatever is passed as a value. For example:`"country=US"`. See [here](https://dev.maxmind.com/geoip/release-notes/2022#geoip-legacy-databases-have-been-retired) for a complete list of country or region geo codes.                                                    |
...
:::image type="content" source="media/debug-auction-geo-detailed.png" alt-text="Screenshot of the debug auction log showing more detailed debug text.":::
