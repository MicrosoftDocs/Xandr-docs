...
| mnc | int | No | The Mobile Network Code as specified by the [ITU](https://www.itu.int/en/publications/ITU-T/Pages/publications.aspx?parent=T-SP&view=T-SP1). |
...
- We use the `curl` command line tool to request the ad from the server; for more information about `curl`, see the project website at [https://curl.haxx.se/](https://curl.se/)
