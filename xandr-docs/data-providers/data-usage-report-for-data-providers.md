...
| line_item_id | int | yes | yes | `12345` | The ID of the line item is associated with the impressions that used third-party data targeting. |
| line_item_name | string | no | no | `line item name` | The line item name is associated with the impressions that used third-party data targeting. |
