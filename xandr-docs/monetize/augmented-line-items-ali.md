...
description: Learn how Augmented line items (ALI) streamline a trader's workflow on the Microsoft Advertising platform, and what are the advantages of using it.  
ms.date: 10/21/2025
