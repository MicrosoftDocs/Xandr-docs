...
We are updating the API host address for Yield Analytics from `yieldanalytics.xandr.com` to `api.appnexus.com`. As a part of this change:

- We are updating the current API endpoint yieldanalytics.xandr.com to point to the new host endpoint api.appnexus.com.
