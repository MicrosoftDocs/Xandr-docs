...
description: This page is a step-by-step guide to target users on the basis of demographic information. 
ms.date: 10/21/2025
...
1. In the **Demographics** section in the **Audience & Location Targeting** section of the augmented line item, click the pencil icon next to **Demographics**. (For a standard line item or campaign, this setting is located in the **Targeting** settings.)
