...
Search behavior depends on the selected view:

* In **Direct view**, the search field searches across all **placement names and placement IDs**.
* In **Tree view**, the search field searches across **placement group names, placement group IDs, placement names, and placement IDs**.

Matching results appear in the grid as you search.
...
1. Select **Filters**.
2. Choose the **Placement Group** filter.
3. Select the placement group you want to view.

The grid updates to display placements that match the selected filter.
...
1. Check the boxes for the placements you want to report on.
2. Select **Run Report** in the table header.
