...
| **Creative** | No eligible creatives; associate an active creative to see delivery | The line item has been defined to manage creatives at the line item level, but there are no creatives associated with the line item. See [Create an Augmented Line Item](create-an-augmented-line-item-ali.md) for more information. |
