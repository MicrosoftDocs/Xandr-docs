...
- [Insertion order](create-an-insertion-order.md): Create an insertion order with **Impressions** or **Flexible Budget Type**, **Unlimited Budget**, **Set pacing on the line item** settings.
...
- **Margin Type**: Curator margin types are configured on a [curated deal line item](create-a-curated-deal-line-item.md). There are two types of curated margins corresponding to the curated deal line item. For more information, see [Curated deal floors](curated-deal-floors.md). Choose from the following options:
  ...
  - **Automatically increase margin to cover vendor costs**: If enabled, in each auction your margin will automatically be increased to cover the data cost you incurred from using any Data Marketplace segments. It can be used with either the percentage or CPM margin types. See [Data Marketplace Overview](../curate/data-marketplace-overview.md) for more details.
...
- **Segment Targeting**: Set which first-party or third-party segments you wish to target, including those from the Data Marketplace. For more information, see [Segment Targeting](segment-targeting.md) and [Data Marketplace Overview](../curate/data-marketplace-overview.md).
...
- **Video Player Targeting**: Target video inventory based on the position, playback method, player width, video framework, and creative duration. For more information, see [Video Targeting](video-targeting.md).
...
- **COPPA**: Select this checkbox to only target COPPA-compliant inventory. For more information, see [Set up line item inventory and brand safety](../monetize/set-up-line-item-inventory-and-brand-safety.md).
...
- [Deals lists for curated deals](deal-lists-for-curated-deals.md)
