...
| `geo_country` | enum | `"CA"` | A two-character string denoting the country in which the impression was viewed. <br><br>**Default**: `"--"` (This means "no country code," or "worldwide targeting.")<br>**Filter by**: Yes |
