...
`ANVideoPlayerSettings` lets your app customize video-player UI controls. These settings apply to all video ads served by the iOS SDK — Instream Video, Banner Video (Outstream), and Interstitial Video.
