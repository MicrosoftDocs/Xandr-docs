...
1. Do one of the following:
    ...
    - To add native creatives that will be hosted with Microsoft Advertising, Select the **Native** button.
    - To add video, audio, and display creatives that will be trafficked through a third-party ad server, select the **Third-Party** button.

    If you selected the **Native** or **Third-Party** button, the appropriate **Create New Creatives** screen will display.

1. Upload the creatives by doing one of the following:
    1. Drag and drop the actual assets or select **Select File** to locate them from your computer.
    1. For hosted and native creatives, select **Select File (xls, xlsx)** within the **Creative Spreadsheet** section and upload the assets using a spreadsheet.
    1. For third-party creatives, select **Select File (xls, xlsx, txt using Sizmek formatting)** within the **Creative Spreadsheet** section and upload the assets using a spreadsheet.
...
1. Do one of the following if uploading the assets using a spreadsheet:
    ...
    1. If all columns were not successfully mapped, use the available menus to manually select the corresponding column names that were included in your spreadsheet, and then select **Review**.

    For more information, see [Creative Spreadsheet Conventions](creative-spreadsheet-conventions.md).

1. Select **Review**.
1. Select the appropriate tabs (**Video, Audio,** and **Banner**) and review all configurations for each asset to ensure additional updates aren't needed.
    ...
    and selecting any one of the bulk edit actions from the menu that displays, or selecting the pencil icon that displays within any of
