...
1. Select a **Payment Model** to define the basis on which you will pay for the media. The payment model you choose will limit the **Revenue Type** options that are available.
    ...
    | **Outcomes** | Select this payment model type to use Guaranteed Outcomes, so you pay only for impressions that achieve a desired outcome. Available outcomes depend on the line item ad type. For more detailed information and configuration instructions, see [Guaranteed Outcomes](guaranteed-outcomes.md). |
...
1. **Optional:** Select **+ Add Subflight** to create one or more subflights that you can use to further customize flight pacing and spend.
    ...
    1. Set subflight pacing.
        ...
        | **Daily budget** | The amount of budget spent per day. <br> The budget can be currency, imps, completes, or views, depending on the budget type and payment model you selected earlier. <br><br> **Note**: If your line item is underspending when using subflights with daily budgets, underspend catch-up settings will take effect once those subflights have ended. |
