...
1. Go to the login page of Microsoft Invest and select **Reset Password**.
...
1. If you forgot your password, go to the login page of Microsoft Invest and select **Reset Password**.
