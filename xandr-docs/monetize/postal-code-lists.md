...
> - Postal code lists that have not been modified in the past 6 months and are not associated with line items that have served in the last 6 months are eligible to be deleted by Microsoft Advertising.
