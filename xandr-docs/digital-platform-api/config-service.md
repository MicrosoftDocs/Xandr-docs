...
| `label` | string | The name of the default Prebid price bucket tier. For more information, see the [Price Granularity](https://docs.prebid.org/adops/price-granularity.html).|
