...
description: Explore FAQs on the Customer Support Portal, providing insights into common queries for better understanding.
...
If you're new to the Customer Support Portal, please visit the [Login](https://support.ads.microsoft.com) page, proceed as a Guest, and click **Contact Support**. Once you've registered, your username will be the email address that you submitted during registration.
